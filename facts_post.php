...
print_r($_POST);
$icon = $_POST['icon'];
$clients_number = $_POST['clients_number'];
$project_type = $_POST['project_type'];
$project_details = $_POST['project_details'];

$ab = insert_que("facts","icon, clients_number, project_type, project_details", "'$icon','$clients_number','$project_type','$project_details'");
