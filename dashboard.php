<?php
  ...
  ?>
    ...
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="sl-mainpanel bg_color_menu">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="index.html">P D F</a>
      ...
      <div class="sl-pagebody">
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-8">
            <div class="card overflow-hidden bg_color_update">
            ...
            <div class="card pd-20 pd-sm-25 mg-t-20 bg_color">
              <h6 class="card-body-title tx-13 color_text">Horizontal Bar Chart</h6>
              <p class="mg-b-20 mg-sm-b-30 color_text">A bar chart or bar graph is a chart with rectangular bars with lengths proportional to the values that they represent.</p>
