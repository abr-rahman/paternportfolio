...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody bg_color_menu">
        ...
        <div class="card pd-20 pd-sm-40 bg_color color_text">
          ...
          <form action="professional_post.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-layout">
            ...
            <div class="form-layout-footer">
              <button type="submit" class="btn btn-info mg-r-5">Add professional Experiance</button>
            </div><!-- form-layout-footer -->
        </form>
            <hr>
              <h6>professional Experiance Section</h6>
              <table class="table">
                <thead>
                  <tr>
          ...
          <?php foreach(query_port("pro_experiance") as $single_professional) : ?>
                <tbody class="tr_color">
                  <tr class="tr_color">
                    <td class="tr_color td_text text-center"><?= $single_professional['exam_name'] ?></td>
                    <td class="td_text text-center"><?= $single_professional['duration'] ?></td>
                    <td class="tr_color td_text text-center"><?= $single_professional['institue'] ?></td>
                    <td class="td_text"><?= $single_professional['explain_some'] ?></td>
                    <td class="tr_color td_text text-center">
                     <a id="professional_delete.php?id=<?= $single_professional['id'] ?>" class="btn btn-sm btn-danger delete_btn"><i class="far fa-edit"></i>Delete</a>
                    </td>
                  </tr>
                </tbody>
              <?php endforeach ?>
